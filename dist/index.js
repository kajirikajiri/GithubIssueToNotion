...
const run = () => {
    ...
    try {
        ...
        const notionDatabaseId = (_a = process.env.NOTION_DATABASE_PAGE_URL) === null || _a === void 0 ? void 0 : _a.split("/")[4].split("?")[0];
        ...
        if (notionDatabaseId) {
            notion.pages
                ...
                properties: getPropertiesFromIssue(issueTitle, issueNumber, issueState, numberOfComments, issueUrl
                // issueLabels
                ),
            })
                .then(() => {
            ...
            core.info(`notionDatabaseId: {typeof: ${typeof notionDatabaseId}}, {value: ${notionDatabaseId}} `);
            core.endGroup();
        }
    }
    catch (error) {
...
function getPropertiesFromIssue(issueTitle, issueNumber, issueState, numberOfComments, issueUrl
